    ...
    public class RegisterModel : PageModel
    {
        ...
        private async Task<bool> SendEmailAsync(string email, string subject, string confirmLink)
        {
            try
            {
                ...
                message.From = new MailAddress("noreplygbctravelgroup45@gmail.com");
                ...
                smtpClient.Credentials = new NetworkCredential("noreplygbctravelgroup45@gmail.com", "sjmd rodc zsrh ornq");
